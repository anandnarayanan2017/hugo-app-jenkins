...
podTemplate(label: 'pod-hugo-app', containers: [
    containerTemplate(name: 'hugo', image: 'anandkn/hugo', ttyEnabled: true, command: 'cat'),
    containerTemplate(name: 'html-proofer', image: 'anandkn/html-proofer', ttyEnabled: true, command: 'cat'),
    containerTemplate(name: 'kubectl', image: 'anandkn/kubectl', ttyEnabled: true, command: 'cat',
    ...
    node('pod-hugo-app') {
        ...
        def DOCKER_HUB_ACCOUNT = 'anandkn'
